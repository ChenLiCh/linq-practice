...
namespace prjPosDemo.Views
{
    public partial class FrmProductList : Form
    {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            tProduct uiProduct = _list[_position]; // 畫面上的資料
            dbDemoEntities3 db = new dbDemoEntities3();
        ...
        private void editProductSelected()
        {
            ...
            // 顯示舊資料
            tProduct uiProduct = _list[_position];
            FrmProductEditor f = new FrmProductEditor();
            f.product = uiProduct; // f.customer = uiCustomer = _list[_position] 這 3 個其中一個資料改變，會影響到其他兩個的資料
            f.ShowDialog();
